        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800">Najnowsze ogłoszenia</h1>
                    <sec:authorize access="!isAuthenticated()">
                    <a href="/all/notloggedoffers" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                            class="fas fa-download fa-sm text-white-50"></i>Wszystkie ogłoszenia</a>
                    </sec:authorize>
                    <sec:authorize access="isAuthenticated()">
                        <a href="/offer/all" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
                                class="fas fa-download fa-sm text-white-50"></i>Wszystkie ogłoszenia</a>
                    </sec:authorize>
                </div>
                ...
                <!-- Content Row -->
                <div class="row">
                    <c:forEach items="${topFiveOffers}" var="top5">
                    <div class="col-lg-12">
                            ...
                            <div class="card-body">
                                <div class="offer-div">
                                    <div class="offer-inside-div-photo">
                                        <img src="/img/defaultuserimg.png" width="90" height="90">
                                    </div>
                                    <div class="offer-inside-div">
                                        <h11 class="m-0 font-weight-bold text-primary">${top5.title}</h11>
                                        <br>
                                        <b>Lokalizacja:</b><br>
                                            ${top5.city}
                ...
                <%--       <div class="card shadow mb-4">
                           ...
                           <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse"
                              role="button" aria-expanded="true" aria-controls="collapseCardExample">
                               <h6 class="m-0 font-weight-bold text-primary">${userOffer.title}</h6>
                           </a>
                           <!-- Card Content - Collapse //bylo class=collapse show zamienione na collapse hide -->
                           <div class="collapse hide" id="collapseCardExample">
                               <div class="card-body">
                                   Zdjecie z ogłoszenia....
                                   <br>
                                   <span style="font-size: x-large">Lokalizacja: ${userOffer.city}</span><br><hr>
                                   <c:if test="${not empty userOffer.adress}">
                                       <span style="font-size: x-small">Adres szczegółowy: ${userOffer.adress}</span><br><hr>
                                   </c:if>
                                   <span style="font-size: x-small">Opis ogłoszenia: ${userOffer.description}</span><br><hr>
                                   <span style="font-size: x-small">Data utworzenia: ${userOffer.created}</span>
